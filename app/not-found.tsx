...
const recoveryLinks = [
  {
    ...
    label: "How It Works",
    description:
      "See how AI Crew Suite automates workflows across your Backstage plugins.",
  },
  {
    href: "/docs",
    label: "Docs",
    description:
      "Browse setup guides, plugin documentation, and platform capabilities.",
  },
  {
    href: "/signup",
    label: "Sign Up",
    description:
      "Start a project request if you were trying to evaluate the product.",
  },
];
        ...
        <div className="flex flex-col justify-center gap-6 text-left">
          <div className="space-y-4">
            ...
            <p className="max-w-2xl text-base leading-7 text-content-offset sm:text-lg">
              This link is gone or moved, but the main parts of the marketing
              site are still easy to reach. Jump back into the tour, docs, or
